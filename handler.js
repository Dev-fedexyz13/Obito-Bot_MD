...
const allowedBots = Array.isArray(chat.per) ? chat.per : []
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|ai|nagi|a|s)/gi)) {
